...
module HarzardUnit(
    ...
    input wire branch_predict_miss,
    ...
    // generate bubbleF, flushF, bubbleD, flushD, bubbleE, flushE
    always @ (*) begin
        if (rst) begin
            bubbleF = 0;
            flushF = 1;
            ...
            bubbleE = 1;
            flushE = 0;
        end else if (wb_select == 1 && (reg_dstE == reg1_srcD || reg_dstE == reg2_srcD)) begin
            // load-use hazard
            bubbleF = 1;
            flushF = 0;
            bubbleD = 1;
            ...
            bubbleE = 0;
            flushE = 1;
        end else if (branch_predict_miss==1) begin
            bubbleF = 0;
            flushF = 0;
            bubbleD = 0;
            flushD = 1;
